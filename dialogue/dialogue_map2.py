...
class Dialogue(object):
    def __init__(self, WINDOW_WIDTH, WINDOW_HEIGHT):
        ...
        self.dialogue_texts = [
            f"YORD: HELLO {self.player_name}, I HEARD YOU ARE LOOKING FOR RUST BOWL",
            f"{self.player_name}: HOW.. HOW DO YOU KNOW?",
            "YORD: THAT'S NOT IMPORTANT! FOR NOW, YOU MUST GO THROUGH THE FOREST",
            f"{self.player_name}: ...",
            f"YORD: GOOD LUCK {self.player_name}"
        ]
