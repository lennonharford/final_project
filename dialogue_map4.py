...
class Dialogue(object):
    def __init__(self, WINDOW_WIDTH, WINDOW_HEIGHT):
        ...
        self.dialogue_texts = [
            "PIP: WELCOME TO THE FORESET OF NEOM",
            f"{self.player_name}: IS THIS THE WAY TO RUST BOWL..",
            "PIP: YES",
            f"{self.player_name}: WHICH WAY?",
            "PIP: FOLLOW THE WINDS",
            f"{self.player_name}: WHAT?",
            "PIP: ...",
        ]
